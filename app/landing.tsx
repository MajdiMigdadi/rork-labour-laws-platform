      ...
      <View style={styles.content}>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <View key={index} style={styles.featureCard}>
                  ...
                  <Text style={[styles.featureDescription, isRTL && styles.rtlText]}>{feature.description}</Text>
                </View>
              );
            })}
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.benefitsList}>
            {benefits.map((benefit, index) => (
              <View key={index} style={[styles.benefitItem, isRTL && styles.rtl]}>
        ...
        <View style={styles.statsSection}>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>Laws</Text>
          </View>
          <View style={styles.statItem}>
        ...
        <View style={styles.ctaSection}>
          ...
          <Text style={[styles.ctaText, isRTL && styles.rtlText]}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>{langSettings?.footerText || settings.footerText}</Text>
        </View>
      </View>
    </ScrollView>
  );
